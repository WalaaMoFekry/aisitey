...
export async function initProject() {
  ...
  try {
    ...
    console.log(chalk.blue('  2. Edit your project-overview.md'));
    console.log(chalk.blue('  3. Define your architecture'));
    console.log(chalk.blue('  4. Start building with AI'));
  } catch (error) {
...
function getTemplateContent(template: string, projectName: string, techStack: string): string {
