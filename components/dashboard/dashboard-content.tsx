...
import { FolderTree, FileText, Cpu, Plus, ArrowRight, Sparkles, Trash2, AlertTriangle } from 'lucide-react';
    ...
    <>
      ...
      {projectToDelete && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
          ...
          {/* Modal */}
          <div className="relative w-full max-w-md rounded-3xl border border-default bg-surface p-8 shadow-2xl">
            {/* Icon */}
            ...
            {/* Title */}
            <h3 className="mt-6 text-center text-xl font-semibold text-copy-primary">
              Delete Project?
            </h3>

            {/* Description */}
            <p className="mt-3 text-center text-sm leading-6 text-copy-secondary">
            ...
            <div className="mt-8 flex gap-3">
              <button
                onClick={() => setProjectToDelete(null)}
                className="flex-1 rounded-xl border border-default px-5 py-3 text-sm font-medium text-copy-primary transition-colors hover:bg-subtle"
              >
                Cancel
              </button>
              <button
                ...
                className="flex-1 rounded-xl bg-red-500 px-5 py-3 text-sm font-medium text-white transition-colors hover:bg-red-600 disabled:opacity-50"
              >
